...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='image_text',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='collection.entryimage'),
        ),
        migrations.AddField(
            model_name='titleentry',
            name='text',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='collection.entrytext'),
        ),
        migrations.AddField(
            model_name='titleentry',
            name='title',
